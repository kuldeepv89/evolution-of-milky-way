      ...
      SUBROUTINE MW(at1,at2,atauin,aSDR,aTTspi,
     $aAFEHv,aaspiv,aAMFv,aAOFEv, aAMGFEv)
      PARAMETER (NMAX=37) 
...
CCC         
      ...
      real t1,t2,tauin
      REAL TTspi,AFEHv,aspiv,AMFv,AMGFEv,AOFEv
      REAL MI,MS,MU
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      DIMENSION aAOFEv(3000),aAMGFEv(3000)
      DIMENSION TTspi(3000),AFEHv(3000),aspiv(3000),AMFv(3000)
       DIMENSION AOFEv(3000),AMGFEv(3000)
...
C Parte per tener conto dei raggi cosmici.
      ...
      COMMON/mod/threshold,modello
       ...
       COMMON/MCMC/TTspi,AFEHv, aspiv,AMFv,AOFEv,AMGFEv
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
Cf2py intent(in) at1, at2, atauin, aSDR
Cf2py intent(out)  aTTspi,aAFEHv,aaspiv,aamfv,aAOFEv, aAMGFEv    
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      DIMENSION TTspi(3000),AFEHv(3000),aspiv(3000),AMFv(3000)
      DIMENSION AMGFEv(3000),AOFEv(3000)
...
C Parte per tener conto dei raggi cosmici.
      COMMON/RAYS/COSM
      COMMON/mod/threshold,modello
c       COMMON/MCMC/TTspi,AFEHv, aspiv,AMFv
       COMMON/MCMC/TTspi,AFEHv, aspiv,AMFv,AOFEv,AMGFEv 
c      IKU=0
      THR=0.01
      THALO=tauin
