...
def lnprior(theta):
    at1, at2, atauin, avnsol1, avnsol2, aSDR = theta

    if (0.0 < at1 < 7.0 and 0.0 < at2 < 14.0 and 0.0 < atauin < 7.0 and 
        0.0 < avnsol1 < 4.0 and 0.0 < avnsol2 < 4.0 and 1.0 < aSDR < 50.):
        return 0.0
...
def lnlikelihood(theta):
    at1, at2, atauin, avnsol1, avnsol2, aSDR = theta
    attspi, aafehv, aaspiv, aamfv = mw(at1, at2, atauin, avnsol1, avnsol2, aSDR)
...
ndim, nwalkers, nsteps = 6, 100, 400


# Initial guess for the parameters
theta0 = (0.20, 11.0, 6., 0.7, 2.0, 3.6)
